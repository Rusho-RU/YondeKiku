...
import com.dragontwister.yondekiku.managers.TextviewAdapter;
...
//        Textview Initialization
        ...
        mList.setAdapter(textviewAdapter);
...
//        textView.setText(String.join(". ", results) + ".");
        textviewAdapter.addItem(String.join(". ", results) + ".");
        manager.startRecognition();
    }
